...
import co.edu.unal.biketrainer.utils.Utils.PRIMARY_ROUTE_BUNDLE_KEY
import co.edu.unal.biketrainer.utils.Utils.getRouteFromBundle
...
import kotlinx.android.synthetic.main.activity_recording_route.*
...
class RecordingRouteActivity : AppCompatActivity(), OnMapReadyCallback {
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS) {
            locationComponent = mapboxMap.locationComponent.apply {
                activateLocationComponent(
                    LocationComponentActivationOptions.builder(this@RecordingRouteActivity, it)
    ...
    private inner class MyLocationEngineCallback(activity: RecordingRouteActivity) :
